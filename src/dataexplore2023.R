...
# - Dist from S shore
# - site dep 
# - layer (thermal strata)

# I believe that the variables of soak time, year, setting, distance from s shore, and turb
# since multiple measures from same site, will incl site as RE

# Because we have setting in the mix, DO and temp likely are not important since depth
# is pretty related...
